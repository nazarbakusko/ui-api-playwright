...
export class AtlassianLoginPage {
    ...
    public constructor(
        ...
        this._url = 'https://www.atlassian.com/';
    }
    ...
    public async expectPageTitle(): Promise<void> {
        if (this.page.url().includes('home.atlassian')) {
            await expect(this.page).toHaveTitle('Atlassian Home');
        } else {
            await expect(this.page).toHaveTitle('Collaboration software for software, IT and business teams | Atlassian');
        }
    }
